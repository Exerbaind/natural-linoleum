@@include("../../api/marmoretteAcousticData.js");
...
@@include("../../api/DLWCollections.js");

const articles = MarmoretteAcousticArticles();
const table = MarmoretteAcousticTable();
const recomendedCollections = DLWCollectionsList();
const currentCollectionName = "Marmorette Acoustic";
